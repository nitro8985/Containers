#ifndef SRC_LIB_BASE_QUEUE_H_
#define SRC_LIB_BASE_QUEUE_H_
...
namespace s21 {
    ...
    class BaseQueue {
     ...
     public:
        BaseQueue() { }
        BaseQueue(std::initializer_list<value_type> const& items);
     ...
     private:
        void delete_queue();
        void move(BaseQueue& s);
        void copy(const BaseQueue& s);
    };
} // namespace s21

#include "s21_base_queue.inl"

#endif  // SRC_LIB_BASE_QUEUE_H_
